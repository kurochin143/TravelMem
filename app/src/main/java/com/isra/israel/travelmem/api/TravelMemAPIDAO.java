...
public class TravelMemAPIDAO {
    ...
    private static Retrofit retrofit = new Retrofit.Builder()
            ...
            .client(okHttpClient)
            .build();
    public static TravelMemFirebaseAPIInterface apiService = retrofit.create(TravelMemFirebaseAPIInterface.class);

    public interface TravelMemFirebaseAPIInterface {
